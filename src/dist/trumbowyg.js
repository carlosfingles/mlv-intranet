    ...
    Trumbowyg.prototype = {
        ...
        openModal: function (title, content) {
            ...
            var $modal = $('<div/>', {
                ...
                top: t.$btnPane.height(),//t.$box.offset().top + 
                zIndex: 999999999999
            }).appendTo(t.$btnPane.parent());//
        ...
        getDefaultImgDblClickHandler: function () {
            ...
            return function () {
                ...
                if (t.o.imageHeightModalEdit) {
                    options.height = {
                        value: $img.attr('height') ? $img.attr('height') : ''
                    };
                }
