...
$users = new Users($_POST['reg_name'], $_POST['reg_lastname'], null, null, null, $_POST['reg_birthdate'], $_POST['reg_CI'], $_POST['reg_profession'], $_POST['reg_codephone'], $_POST['reg_phone'], $wtpp, $tlg, $_POST['reg_country'], $_POST['reg_states'], $_POST['reg_city'], $_POST['reg_ideology'], $_POST['reg_social'], $_POST['reg_economic'], $_POST['reg_anotherOrganization'], $nets, $_POST['reg_collabNet'], $_POST['reg_collabVoluntary'], $_POST['reg_collabEvents'], $_POST['reg_collabFunds'], $_POST['reg_collabOther']);
